...
# This file was *autogenerated* from the file solve_secret_exponents.sage
from sage.all_cmdline import *   # import sage library

_sage_const_419 = Integer(419); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1)
p = _sage_const_419 
F = GF(p)
primes = [_sage_const_3 , _sage_const_5 , _sage_const_7 ]
secret = [_sage_const_2 , _sage_const_3 , _sage_const_4 ]
...
for l in primes:
    assert (p + _sage_const_1 ) % l == _sage_const_0 
print(f"p = {p},  p + 1 = {factor(p + _sage_const_1 )}")
...
def group_action(A, primes, exponents):
    ...
    for l, e in zip(primes, exponents):
        assert e >= _sage_const_0 , "negative exponents need the twist trick (a later challenge)"
        for _ in range(e):
            A = step(A, l)
    return A
...
A_final = group_action(F(_sage_const_0 ), primes, secret)
...
k3 = cycle.index(step(F(_sage_const_0 ), _sage_const_3 ))
k5 = cycle.index(step(F(_sage_const_0 ), _sage_const_5 ))
print(f"  [l_3] = [l_7]^{k3}")
print(f"  [l_5] = [l_7]^{k5}")

k = (secret[_sage_const_0 ] * k3 + secret[_sage_const_1 ] * k5 + secret[_sage_const_2 ] * _sage_const_1 ) % h
