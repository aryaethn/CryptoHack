...
# This file was *autogenerated* from the file solve_flag.sage
from sage.all_cmdline import *   # import sage library

_sage_const_31337 = Integer(31337); _sage_const_50 = Integer(50); _sage_const_34 = Integer(34); _sage_const_8 = Integer(8); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2)# SageMath script
...
E = _sage_const_31337 
N = _sage_const_50 
FLAG_LEN_BYTES = _sage_const_34 
FLAG_LEN_BITS  = FLAG_LEN_BYTES * _sage_const_8 
...
def bits_to_bytes(bits):
    ...
    for i in range(_sage_const_0 , len(bits), _sage_const_8 ):
        ...
        for j in range(_sage_const_8 ):
            if i + j < len(bits):
                b = (b << _sage_const_1 ) | int(bits[i + j])
        out.append(b)
    return bytes(out)
...
def recover_M_from_C(C):
    ...
    if gcd(E, mC) == _sage_const_1 :
        ...
        if mC % E == _sage_const_0 :
            Z = C**Integer(mC // E)    # order E and commutes with C
            R = Matrix(GF(_sage_const_2 ), identity_matrix(GF(_sage_const_2 ), N))
            for r in range(E):
    ...
    if mC % E == _sage_const_0 :
        ...
        try:
            ...
            M0 = Matrix(GF(_sage_const_2 ), identity_matrix(GF(_sage_const_2 ), N))
...
def main():
    ...
    C = load_cipher_matrix(sys.argv[_sage_const_1 ])
